function [k02_SUC_FAD, k13_SUC_FAD, k24_SUC_FAD,...
    k20_FUM_FADH2, k31_FUM_FADH2, k42_FUM_FADH2, k20_SQ_ISC3_QH2,...
    k31_SQ_ISC3_QH2, k42_SQ_ISC3_QH2, k02_QH2_SQempty_ISC3ox,...
    k13_QH2_SQempty_ISC3ox, k24_QH2_SQempty_ISC3ox,...
    E0, E1, E2, E3, E4] = sdh_c2(suc_m,fum_m,q_m,qh2_m,h_m,p, o2)
...
% general electron acceptor 
% (phenazine or TMPD in studies used - this is usless for me)
% p.Em.GEA = p.Em0.GEA  + p.RTF/2 * log(H);
